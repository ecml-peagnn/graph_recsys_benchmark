...
sys.path.append('..')
from graph_recsys_benchmark.models import GCNInnerRecsysModel
...
class GCNInnerRecsysModel(GCNInnerRecsysModel):
...
if __name__ == '__main__':
    solver = BaseSolver(GCNInnerRecsysModel, dataset_args, model_args, train_args)
    solver.run()
