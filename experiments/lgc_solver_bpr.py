...
sys.path.append('..')
from graph_recsys_benchmark.models import LGCRecsysModel
...
parser.add_argument('--dataset_name', type=str, default='25m', help='')          # 25m, latest-small
...
class LGCRecsysModel(LGCRecsysModel):
...
if __name__ == '__main__':
    solver = BaseSolver(LGCRecsysModel, dataset_args, model_args, train_args)
    solver.run()
