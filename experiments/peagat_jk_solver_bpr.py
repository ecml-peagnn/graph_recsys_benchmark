...
# Model params
parser.add_argument('--jump_mode', type=str, default='max', help='')
...
parser.add_argument('--channel_aggr', type=str, default='mean', help='')
...
model_args = {
    'model_type': MODEL_TYPE, 'jump_mode': args.jump_mode,
    'jump_channels': args.jump_channels, 'jump_num_layers': args.jump_num_layers,
