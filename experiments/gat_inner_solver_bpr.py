...
sys.path.append('..')
from graph_recsys_benchmark.models import GATInnerRecsysModel
...
class GATInnerRecsysModel(GATInnerRecsysModel):
...
if __name__ == '__main__':
    solver = BaseSolver(GATInnerRecsysModel, dataset_args, model_args, train_args)
    solver.run()
